...
const Body = () =>{
  ...
  const fetchData = async () => {
    ...
    if(800<=window.screen.height){
      const data = await fetch('https://corsproxy.io/?https://www.swiggy.com/mapi/restaurants/list/v5?offset=0&is-seo-homepage-enabled=true&lat=12.9715987&lng=77.5945627&carousel=true&third_party_vendor=1')
